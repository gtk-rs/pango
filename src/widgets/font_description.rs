...
impl FontDescription {
    ...
    pub fn set_weight(&mut self, weight: ffi::PangoWeight) {
        unsafe { ffi::pango_font_description_set_weight(self.0, weight) };
    }

    pub fn get_weight(&self) -> ffi::PangoWeight {
    ...
    pub fn set_gravity(&mut self, gravity: ffi::PangoGravity) {
    ...
    pub fn get_set_fields(&self) -> ffi::PangoFontMask {
        unsafe { ffi::pango_font_description_get_set_fields(self.0) }
    }

    pub fn unset_fields(&mut self, to_unset: ffi::PangoFontMask) {
