...
pub trait LayoutExt {
    ...
    //fn get_log_attrs(&self, attrs: /*Unimplemented*/Vec<LogAttr>) -> i32;

    //fn get_log_attrs_readonly(&self) -> (/*Ignored*/Vec<LogAttr>, i32);
    ...
    fn set_markup_with_accel(&self, markup: &str, length: i32, accel_marker: char) -> char;
...
impl<O: IsA<Layout>> LayoutExt for O {
    ...
    fn get_alignment(&self) -> Alignment {
        unsafe {
            ffi::pango_layout_get_alignment(self.to_glib_none().0)
        }
    }
    ...
    fn get_ellipsize(&self) -> EllipsizeMode {
        unsafe {
            ffi::pango_layout_get_ellipsize(self.to_glib_none().0)
        }
    }
    ...
    fn get_wrap(&self) -> WrapMode {
        unsafe {
            ffi::pango_layout_get_wrap(self.to_glib_none().0)
        }
    }
    ...
    fn set_alignment(&self, alignment: Alignment) {
        unsafe {
            ffi::pango_layout_set_alignment(self.to_glib_none().0, alignment);
        }
    }
    ...
    fn set_ellipsize(&self, ellipsize: EllipsizeMode) {
        unsafe {
            ffi::pango_layout_set_ellipsize(self.to_glib_none().0, ellipsize);
        }
    }
    ...
    fn set_wrap(&self, wrap: WrapMode) {
        unsafe {
            ffi::pango_layout_set_wrap(self.to_glib_none().0, wrap);
        }
    }
